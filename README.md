# Guide de démarrage rapide de projets
...
- [Mise à jour automatisé de la BD](./Guide/DevOps/CD.md)
- [Publication d'une librairie commune](./Guide/DevOps/NugetPipeline.md)

# Fiches techniques
## Azure
- [Azure Web App](./Fiches/Azure/WebApp.md)
- [SQL Azure](./Fiches/Azure/SQLAzure.md)
- [Azure Active Directory](./Fiches/Azure/AAD.md)
## Concepts de développement avancés
- [Principes Solid](./Fiches/Dev/SOLID.md)
- [Principes Grasp](./Fiches/Dev/GRASP.md)
